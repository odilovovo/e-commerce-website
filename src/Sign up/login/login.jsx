            ...
            <div className="mt-14 flex items-center justify-around">
                ...
                <div className="flex flex-col mt-8">
                    ...
                    <input
                        ...
                        className="outline-none border-b-2 mt-8 border-gray-500"
                    />
                    <input
                        type="password"
                    ...
                    <button className="bg-red-500 mt-8 p-2 rounded text-white text-center">
                        Login
                    </button>

                    <p className="text-red-500 mt-4 text-sm cursor-pointer">
                        Forgot Password?
                    </p>
                </div>
            </div>
